<template>
    <section class="view-section view-section--background-light p-t-0">
        <div class="view-container">
            ...
            <div class="view-user-edit view-user-edit--create-profile view-grid">
                    ...
                    >
                        ...
                        <div>
                            <div class="view-form__group">
                                ...
                                <textarea name="aboutMe" v-model="userData.resume.text" id="aboutMe" class="view-form__textarea"></textarea>
                            </div>
                            ...
                            <div class="view-form__buttons ta-right">
                                <button class="button button--default" @click.prevent="submit()">
                                    Зберегти
                                </button>
                            </div>
                        </div>
...
export default {
    ...
    methods: {
        ...
        submit() {
            ...
            data.append('participant', JSON.stringify(this.userData));
